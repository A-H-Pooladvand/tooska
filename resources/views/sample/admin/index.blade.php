                ...
                columns: [[
                    ...
                    {field: 'id', sortable: true, title: 'شناسه', align: 'center'},
                    {
                        ...
                        formatter: function (val, row) {
                            return '<a href="' + '{{ route('admin.sample.index') }}' + '/' + row.id + '" target="_blank">' + val + '</a>';
                        }
                    },
                    {field: 'link', sortable: true, title: 'لینک', align: 'center'},
                ...
                toolbar: [
                    {
                        ...
                        iconCls: 'fa fa-eye',
                        handler: function () {
                            window.open('{{ route('admin.sample.index') }}' + '/' + id(), '_blank');
                        }
                    }, '-', {
                        text: 'ویرایش',
                        iconCls: 'fa fa-pencil',
                        handler: function () {
                            window.open('{{ route('admin.sample.index') }}' + '/' + 'edit' + '/' + id(), '_blank');
                        }
                    }, '-', {
                        text: 'حذف',
                            ...
                            $.confirm({
                                ...
                                buttons: {
                                    ...
                                    confirm: {
                                        ...
                                        action: function () {
                                            $.post('{{ route('admin.sample.index') }}' + '/' + ids(), {_method: 'delete'}).done(function (response) {
                                                if (response['error'])
                                                    $.alert({
                                                        title: 'خطا!',
