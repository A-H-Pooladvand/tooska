        ...
        <script>
            let dataGrid = $('#dg').datagrid({
                ...
                toolbar: [{
                    ...
                    iconCls: 'fa fa-eye',
                    handler: function () {
                        window.open('{{ route('admin.tag.index') }}' + '/' + id(), '_blank');
                    }
                }, '-', {
                    text: 'ویرایش',
                    iconCls: 'fa fa-pencil',
                    handler: function () {
                        window.open('{{ route('admin.tag.index') }}' + '/' + 'edit' + '/' + id(), '_blank');
                    }
                }, '-', {
                    text: 'حذف',
                        ...
                        $.confirm({
                            ...
                            buttons: {
                                ...
                                confirm: {
                                    ...
                                    action: function () {
                                        $.post('{{ route('admin.tag.index') }}' + '/' + ids(), {_method: 'delete'}).done(function (response) {
                                            if (response['error'])
                                                $.alert({
                                                    title: 'خطا!',
